...
[CreateAssetMenu(menuName = "Weapons/One Bullet Difficult Fire")]
public class WeaponOneBulletDifficultFire : WeaponFireState
{
    ...
    public override void Fire(Vector2 fireDirection)
    {
        ...
        var bullet = Instantiate(_bulletPrefabs[Random.Range(0, _bulletPrefabs.Length)], _machine.MainFirePoint.position,
