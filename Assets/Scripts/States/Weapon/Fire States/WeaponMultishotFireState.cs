...
[CreateAssetMenu(menuName = "Weapons/Multishot Fire")]
public class WeaponMultishotFireState : WeaponFireState
{
    ...
    public override void Fire(Vector2 fireDirection)
    {
        ...
        for (int i = 0; i < _fireAngles.Length; i++)
        {
            ...
            var bullet = Instantiate(_bulletPrefab, _machine.MainFirePoint.TransformPoint(_fireOffsets[i]),
